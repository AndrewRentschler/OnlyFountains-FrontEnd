...
class Map extends React.Component {
  ...
  logSomething = () => console.log("Clicked!");
    ...
    const sampleMarkerText = {
      ...
      editable: (
        <React.Fragment>
          ...
          <p>
            ...
            div to allow the user to edit the popup's content. It acts as a rich
            text formatter for simple text editing within a popup.
          </p>
          <p>
            <code>&lt;EditablePopup&gt;</code> keeps the newly saved content
            within its own state. But the <code>saveContentCallback</code> prop
            is also available, which takes a callback function of your
            construction to save the content to your preferred state location.
            Your callback arguments should be the popup HTML content as a
            javascript string, as well as the index of the marker (if the marker
            is being generated from an array - see the random markers for more
            info).
          </p>
          <p>
            Once the save button is clicked, the html input is parsed through{" "}
            <a
            ...
            . The initial input that is hard-coded into the popup content must
            be a simple string or a React class or functional component. Read
            more about the formatting of the initial input in the{" "}
            <a
      ...
      lochness: (
        <React.Fragment>
          ...
          <p>
            A removable <code>&lt;EditablePopup&gt;</code> will have a button
            that says "Remove this &lt;thing&gt;". The plugin automatically
            assigns a name to &lt;thing&gt; based on its lealet name. For
            example, a marker will say "Remove this marker," while a polygon
            will say "Remove this polygon." Authors can specify a more
            personalized name by writing the{" "}
      ...
      >
        ...
        >
          <Popup
            ...
            autoClose={false}
          >
            <FC logSomething={this.logSomething} />
          </Popup>
        </Marker>
        ...
        <button id="placeRandomMarkerButton" onClick={this.placeRandomMarker}>
